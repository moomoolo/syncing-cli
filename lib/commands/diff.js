...
function diffDefault() {
    ...
    console.log(tips_1.default.dirDiffResult((0, diffDirectories_1.default)(dirOne, dirTwo)));
}
function diffOrder() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(tips_1.default.dirDiffResult((0, diffDirectories_1.default)(oldDir, newDir)));
    });
}
