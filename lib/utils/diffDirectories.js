...
function diffDirectories(oldDir, newDir, options = {}) {
    ...
    if (options.log) {
        addedList.length > 0 && console.log(tips_1.default.addedList(addedList));
        deletedList.length > 0 && console.log(tips_1.default.deletedList(deletedList));
        changedList.length > 0 && console.log(tips_1.default.changedList(changedList));
    }
    return {
        same: res.same,
        addedList,
