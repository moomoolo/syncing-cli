...
const setDirectories = (dirList) => {
    let res = `📂 ${(0, colors_1.yellow)('set directories: ')}`;
    const [oldDir, newDir] = dirList;
    res += `\n   ${(0, colors_1.cyan)(oldDir)} ${(0, colors_1.grey)('(default old)')}`;
    res += `\n   ${(0, colors_1.cyan)(newDir)} ${(0, colors_1.grey)('(default new)')}`;
    return res;
};
const showDirectories = (dirList) => {
    let res = `📂 ${(0, colors_1.yellow)('directories: ')}`;
    const [oldDir, newDir] = dirList;
    res += `\n   ${(0, colors_1.cyan)(oldDir)} ${(0, colors_1.grey)('(default old)')}`;
    res += `\n   ${(0, colors_1.cyan)(newDir)} ${(0, colors_1.grey)('(default new)')}`;
    return res;
